...
from ..backends.metadata.models import GeoPoint, UavImageMetadata
...
async def create_uav_image(
    ...
    """
    return CreateResponse(image_id=uuid4())
...
@router.get("/{image_id}")
async def get_image(image_id: UUID) -> bytes:
    """
...
async def query_images(
    ...
    """
    return QueryResponse(image_ids=[], page_num=page_num, is_last_page=True)
